                    ...
                    <div className="row d-flex flex-wrap align-items-center">
                        ...
                        <div className="lqd-column col-md-4 col-xs-12">
                            {
                                this.props.skills.filter(sk => sk.columnOrder === 1).map(sk => {
                                    return <div key={sk.id} className="iconbox text-right mb-70">
                                        <div className="contents">
                                        <h3 className="font-size-20 pb-0 font-weight-semibold">{sk.title}</h3>
                                            <p className="font-size-16">{sk.description}</p>
                                        </div>
                                    </div>
                                })
                            }
                        ...
                        <div className="lqd-column col-md-4 col-xs-12 visible-lg visible-md px-md-6">
                            <figure className="mb-70">
                                <img className="img-responsive img-circle" src="/assets/img/misc/hands.jpg" alt="Hands" />
                            </figure>
                        </div>{/* /.lqd-column col-md-4 col-xs-12 */}
                        <div className="lqd-column col-md-4 col-xs-12">
                            {
                                this.props.skills.filter(sk => sk.columnOrder === 2).map(sk => {
                                    return <div key={sk.id} className="iconbox iconbox-sm text-left mb-70">
                                        <div className="contents">
                                            <h3 className="font-size-20 pb-0 font-weight-semibold">{sk.title}</h3>
                                            <p className="font-size-16">{sk.description}</p>
                                        </div>
