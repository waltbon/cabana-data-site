...
const Page: NextPage<Props> = ({ seo, mobileDevelopmentPage }) => {
    const page = mobileDevelopmentPage;
    return (
        <PageLayout url="/mobile-development" seo={mobileDevelopmentPage.seo}>
                ...
                <div className="container">
                    <div className="row">
                        <div className="lqd-column col-md-8 col-md-offset-2 text-center">
                            <h2 className="text-uppercase text-white mt-0 pb-10">{mobileDevelopmentPage.formTitle}</h2>
                            <p className="font-size-18 text-white px-md-7 mx-md-3 mb-50 pb-60">{mobileDevelopmentPage.formTitlebarSubtitle}</p>
                            ...
                            <div className="row pt-20">
                                <div className="lqd-column col-md-10 col-md-offset-1">
                                    <div className="contact-form contact-form-inputs-underlined contact-form-button-circle">
                                        <SoftwareDevelopmentForm projectTypes={mobileDevelopmentPage.projectTypes} />
                                    </div>
                                </div>
                            </div>
                        </div>
...
const QUERY = (lang: string) => `query {
    mobileDevelopmentPage(locale: ${lang}) {
        headerTitle,
        headerSubtitle,
        headerDescription,
        tabsHeader
